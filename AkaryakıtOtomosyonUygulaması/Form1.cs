...
namespace AkaryakıtOtomosyonUygulaması
{
    public partial class Form1 : Form
    {
        double D_benzin95, D_benzin97, D_dizel,D_eurodizel,D_lpg;
        double E_benzin95, E_benzin97, E_dizel, E_eurodizel, E_lpg;
        double S_benzin95, S_benzin97, S_dizel, S_eurodizel, S_lpg;
        double F_benzin95, F_benzin97, F_dizel, F_eurodizel, F_lpg;
        ...
        {
            depo_bilgileri = System.IO.File.ReadAllLines(Application.StartupPath + "\\depo.txt");//depo.txt deki her satırı oku depo bilgilerine ekle application .startuppath depug klasörünü belirtir.
        ...
        private void prograsBar_guncelle()
        {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            prograsBar_guncelle();
            numericupdown_value();
            string[] yakıtturu = { "BENZİN (95)", "BENZİN (97)", "DİZEL", "EURO DİZEL", "LPG" };
            comboBox1.Items.AddRange(yakıtturu);
